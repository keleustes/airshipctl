...
func RunValidateCluster() error {
	...
	if err := register.ValidateClusterAPIObjects(context.TODO(), os.Stdout, c, vco.KubeconfigOverrides.Context.Cluster, vco.KubeconfigOverrides.Context.Namespace); err != nil {
		return err
	}
	if err := register.ValidatePods(context.TODO(), os.Stdout, c, metav1.NamespaceSystem); err != nil {
		return err
	}
