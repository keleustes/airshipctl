...
import (
	...
	"k8s.io/klog"
	cluserclient "opendev.org/airship/airshipctl/pkg/client/cluster"
	"opendev.org/airship/airshipctl/pkg/clusterdeployer/bootstrap"
	"opendev.org/airship/airshipctl/pkg/clusterdeployer/provider"
...
type ClusterDeployer struct {
	...
	clientFactory           cluserclient.Factory
...
func (d *ClusterDeployer) Create(resources *yaml.ParseOutput, kubeconfigOutput string, providerComponentsStoreFactory provider.ComponentsStoreFactory) error {
	...
	controlPlaneMachines, nodes, err := cluserclient.ExtractControlPlaneMachines(machines)
	if err != nil {
...
func (d *ClusterDeployer) Delete(targetClient cluserclient.Client) error {
...
func deleteClusterAPIObjectsInAllNamespaces(client cluserclient.Client) error {
...
func closeClient(client cluserclient.Client, name string) {
	if client != nil {
