...
import (
	...
	"k8s.io/klog"
	"opendev.org/airship/airshipctl/pkg/client/cluster"
...
func GetKubeconfig(bootstrapClient cluster.Client, kubeconfigOutput string, clusterName, namespace string) (string, error) {
...
func waitForKubeconfigReady(bootstrapClient cluster.Client, clusterName, namespace string) (string, error) {
