...
func (s *sourcer) WaitForClusterV1alpha3Ready() error {
	return nil
}
...
func (t *target) WaitForClusterV1alpha3Ready() error {
	return nil
}
...
func (s *waitFailSourcer) WaitForClusterV1alpha3Ready() error {
	return errors.New("failed to wait for ready cluster resources")
}
func TestWaitForV1alpha3Failure(t *testing.T) {
